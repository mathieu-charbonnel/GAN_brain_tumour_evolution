...
class AlignedDatasetTPN(BaseDataset):   ## train
    ...
    def __getitem__(self, index):
        ...
        return {'A': A, 'B': B,
            'A_paths': AB_path, 'B_paths': AB_path, 'diff_map': diff_map, 'time_period': time_period}
...
class TestAlignedDatasetTPN(BaseDataset):
    def initialize(self, opt):
        self.opt = opt
        self.root = opt.dataroot
        self.dir_AB = os.path.join(opt.dataroot, opt.phase)
