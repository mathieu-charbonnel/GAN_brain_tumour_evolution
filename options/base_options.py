...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataset_mode', type=str, default='unaligned', help='chooses how datasets are loaded. [unaligned | aligned | single | aligned_time ]')
        self.parser.add_argument('--model', type=str, default='gea_gan',
                                 help='chooses which model to use. [gea_gan | dea_gan | time_predictor | gea_TPN | gea_DM]')
